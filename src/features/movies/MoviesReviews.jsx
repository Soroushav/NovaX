...
function MoviesReviews() {
  const { movieReviews, isLoading: isLoadingReviews } = useMovieReviews();
  if (isLoadingReviews || !movieReviews) return <Spinner />;
  return (
    <>
      {/* Review */}
            ...
            <div className="ml-4 mt-4 flex flex-col gap-3">
              ...
              <div className="flex items-center gap-2">
                ...
                <div>
                  <img
                    src={
                      movieReviews[0]?.author_details.avatar_path
                        ? `https://image.tmdb.org/t/p/original${movieReviews[0].author_details.avatar_path}`
                        : "/default-user.jpg"
                    }
                    alt={movieReviews[0]?.author}
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <div className="flex gap-2 items-center">
                    ...
                    <p className="text-stone-600 ">
                      ...
                      on{" "}
                      <span>{movieReviews[0]?.updated_at.slice(0, 10)}</span>
                    </p>
                  </div>
                </div>
              </div>
